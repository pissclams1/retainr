...
const priceFeatures = {
  starter: ['GA4 connection per client', 'Monthly client report', 'Internal briefing card', 'White-label reports', 'Threshold alerts'],
  growth: ['Everything in Starter', 'Commitments tracker', 'Account health scores', 'Daily data refresh', 'Mobile briefing card'],
  agency: ['Everything in Growth', 'Priority support', 'Early access to V2 features', 'Google Ads integration (V2)', 'Custom onboarding call'],
}
    ...
    <div style={{ fontFamily: "'Geist', sans-serif", background: '#FFFFFF' }}>
      ...
      <section style={S.heroBand}>
        <div style={S.heroInner}>
          ...
          <p style={S.heroSub}>
            Retainr connects to your clients' GA4 accounts and automatically generates a branded client report and a private pre-call briefing card — so your account managers know exactly what's coming before they pick up the phone.
          </p>
        ...
        <div style={S.sectionInner}>
          ...
          <div style={S.outputsGrid}>
            <div style={S.outputCard}>
              ...
              <p style={S.outputDesc}>A white-labeled report designed to justify the retainer and survive the client's internal budget review. Your agency name, your brand color — delivered as a shareable link.</p>
            ...
            <div style={S.outputCard}>
              ...
              <p style={S.outputDesc}>A private card that prepares your account manager for the hardest version of every unexpected client call. The concern surfaces first. Always.</p>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div style={S.pricingGrid}>
            {[
              ...
              <div key={plan.tier} style={plan.featured ? S.priceCardFeatured : S.priceCard}>
                ...
                <Link to="/login" style={{ ...S.priceBtn, ...(plan.featured ? S.priceBtnFilled : S.priceBtnOutline) }}>Get started</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={S.ctaSection}>
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          ...
          <p style={S.ctaSub}>Connect your first client in under 10 minutes. The first report and briefing card generate automatically.</p>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
            <Link to="/login" style={S.ctaPrimaryDark}>Get started free</Link>

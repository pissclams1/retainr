...
export default function GenerateLinkPage() {
  ...
  async function handleGenerate(e) {
    ...
    try {
      ...
      // Override URL to use current origin so it works in all environments
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: loading || !agentName.trim() ? '#94A3B8' : C.navy,
          ...
          <div>
            ...
            <div style={{ borderRadius: 10, border: `1.5px solid ${C.greenBorder}`, background: C.greenBg, padding: '14px 16px', marginBottom: 12 }}>
              ...
              <button
                onClick={handleCopy}
                style={{
                  padding: '8px 16px', borderRadius: 8, border: `1.5px solid ${C.greenBorder}`,
                  background: copied ? C.green : '#fff', color: copied ? '#fff' : C.fg,
